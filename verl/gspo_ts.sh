...
weekly_dir=${WEEKLY_DATA_DIR:-/data/dinghang/rl/tsrl/rl_data/_Weekly}
train_parquet=${TRAIN_PARQUET:-${weekly_dir}/train.parquet}
test_parquet=${TEST_PARQUET:-${weekly_dir}/test.parquet}
