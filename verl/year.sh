...
Yearly_dir=${YearLY_DATA_DIR:-/data/dinghang/rl/tsrl/rl_data/_Yearly}
train_parquet=${TRAIN_PARQUET:-${Yearly_dir}/train.parquet}
test_parquet=${TEST_PARQUET:-${Yearly_dir}/test.parquet}
