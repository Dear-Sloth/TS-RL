    ...
    async def train_gen(self):
        ...
        for i, (batch_x, batch_y, batch_x_mark, batch_y_mark) in enumerate(train_loader):
            ...
            for j in range(batch_x.shape[0]):
                ...
                tasks.append((task, sys_prompt, input_query, y_string))  # 加上y_string
                ...
                if len(tasks) >= max_concurrency:
                    ...
                    # 处理结果
                    for (reasons, anss), (_, sys_prompt, input_query, y_string) in zip(results, tasks):
                        if reasons and anss:
                            tmp = {
                                ...
                                "reason": reasons,
                                "answer": anss,
                                "ground_truth": y_string  # 加一行，把真实future加进去！
                            }
